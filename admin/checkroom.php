					...
					while ($row = mysql_fetch_array($result)) {
						if($row['availableroom'] != null && $row['availableroom'] > 0  )
						{
							...
							if(mysql_num_rows($sub_result) > 0)
							{
								...
								print "				<form name=\"form".$sub_row['room_id']."\" action=\"guestform\" method=\"post\" onsubmit=\"return validateForm(".$sub_row['room_id'].");\">\n";
							...
							if(mysql_num_rows($sub_result2) > 0)
							{
								...
								print "				<form name=\"form".$sub_row2['room_id']."\" action=\"guestform\" method=\"post\" onsubmit=\"return validateForm(".$sub_row2['room_id'].");\">\n";
