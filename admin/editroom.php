  ...
  <body>
      ...
      <div class="container-fluid" style="background-color: #4aa3df;">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="signout" style="color: #ffffff;">Sign Out</a></li>
          </ul>
        </div>
      </div>
    </nav>
    ...
    <div class="container-fluid">
      <div class="row">
		...
		print "					  </div>\n";
		print "					   <div class=\"form-group\">\n";
		print "						<label for=\"capacity\">Capacity</label>\n";
		print "						<input type=\"text\" class=\"form-control\" name=\"capacity\" id=\"capacity\" placeholder=\"max number of occupant\" value=\"".$rows['capacity']."\">\n";
		print "					  </div>\n";
		print "					  <div class=\"form-group\">\n";
		...
		print "					  </div>\n";
		print "					  <div class=\"form-group\">\n";
		print "						<label for=\"bed\">Bed Size</label>\n";
		print "						<input type=\"text\" class=\"form-control\" name=\"bed\" id=\"bed\" placeholder=\"example: city view\" value=\"".$rows['bed']."\">\n";
		print "					  </div>\n";
		print "					  <div class=\"form-group\">\n";
		print "						<label for=\"rate\">Rate</label>\n";
		print "						<input type=\"text\" class=\"form-control\"  name=\"rate\" id=\"rate\" placeholder=\"Write without $ or RM\" value=\"".$rows['rate']."\" required>\n";
		print "					  </div>\n";
		print "					  <div class=\"form-group\">\n";
