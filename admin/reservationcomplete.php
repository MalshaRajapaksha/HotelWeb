...
<div class="large-12 columns">
		<div class="large-3 columns centerdiv">
			<a href="index" class="button round blackblur fontslabo" >1</a>
			<p class="fontgrey">Please select Date</p>
		</div>
		<div class="large-3 columns centerdiv">
			<a href="checkroom" class="button round blackblur fontslabo" >2</a>
			<p class="fontgrey">Select Room</p>
		</div>
		<div class="large-3 columns centerdiv">
			<a href="guestform" class="button round  blackblur fontslabo" >3</a>
...
<div class="row">
	<div class="large-4 columns blackblur fontcolor" style="margin-left:-10px; padding:10px;">
		...
		<p><b>Your Reservation</b></p><hr class="line">
				<form name="guestdetails" action="checkroom" method="post" >
				<div class="row">
					<div class="large-12 columns">
						<div class="row">
	...
	<div class="large-8 columns blackblur fontcolor" style="padding:10px">
		...
		<div class="row">
			<div class="large-12 columns" >
					...
					<input type="hidden" name="item_name" value="15% Hotel Offer Payment">
					<input type="hidden" name="amount" value="<?php $amount = $_SESSION['offer']; print $amount; ?>">
					...
					<br><button class="button small " border="0" name="submit" alt="PayPal - The safer, easier way to pay online!" style="width:32%;background-color:#2ecc71; ">Pay Room Offer Now</button>
