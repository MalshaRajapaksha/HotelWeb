...
<div class="row " >
	<div class="large-4 columns blackblur "  style="margin-top:100px; ">
		<p class="fontslabo " style="text-align:left; font-size:18px;"><br><h4>Payment Offer Accepted</h4><hr> Dear <?php echo $_SESSION['firstname'];?>, <br>Please check your email regarding your offer payment through PayPal. Thank you on using our facility.</p>
		<br>
