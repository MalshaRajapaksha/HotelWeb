					...
					while ($row = mysql_fetch_array($result)) {
						...
						if($row['availableroom'] != null && $row['availableroom'] > 0  )
						{
							...
							if(mysql_num_rows($sub_result) > 0)
							{
								...
								print "						</div>\n";
								print "						<div class=\"large-4 columns\">\n";
								print "						<p><span class=\"fontgrey\">Capacity : </span> ".$sub_row['capacity']."<br>\n";
								print "						<span class=\"fontgrey\">Size : </span> ".$sub_row['size']."\n";
								print "						<br><span class=\"fontgrey\">Bed Size : </span> ".$sub_row['bed']."</p>\n";
								print "\n";
								print "						</div>\n";
								print "						<div class=\"large-4 columns\">\n";
							...
							if(mysql_num_rows($sub_result2) > 0)
							{
								...
								print "						</div>\n";
								print "						<div class=\"large-4 columns\">\n";
								print "						<p><span class=\"fontgrey\">Capacity : </span> ".$sub_row2['capacity']."<br>\n";
								print "						<span class=\"fontgrey\">Size : </span> ".$sub_row2['size']."\n";
								print "						<br><span class=\"fontgrey\">Bed Size : </span> ".$sub_row2['bed']."</p>\n";
								print "\n";
								print "						</div>\n";
								print "						<div class=\"large-4 columns\">\n";
								print "						<p ><span class=\"fontgrey\">Rate : </span><span style=\"font-size:24px;\">".$sub_row2['rate']."$</span><span class=\"fontgrey\">/ Pernight</span><br>\n";
