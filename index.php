    ...
    <section class="hero-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="hero-text">
                        <h1>SeaSide South Park A Luxury Hotel</h1>
                ...
                <div class="col-xl-4 col-lg-5 offset-xl-2 offset-lg-1">
                    <div class="booking-form">
                        ...
                        <form action="checkroom.php" method="post" onSubmit="return validateForm(this);">
                            <div class="check-date">
                                <label class="fontcolor" for="checkin">Check In:</label>
                                <input name="checkin" id="checkin">
                                <i class="icon_calendar"></i>
                            </div>
                            <div class="check-date">
                                <label class="fontcolor" for="checkout">Check Out:</label>
                                <input name="checkout" id="checkout">
                                <i class="icon_calendar"></i>
                            </div>
                            <div class="select-option">
                                <label class="fontcolor">Adults:</label>
                            ...
                            <div class="select-option">
                                <label class="fontcolor">Children:</label>
