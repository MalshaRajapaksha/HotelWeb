...
include './auth.php';
mysql_query("INSERT INTO booking (booking_id, total_adult, total_children, checkin_date, checkout_date, special_requirement, payment_status, total_amount, offer, first_name, last_name, email, telephone_no, add_line1, add_line2, city, state, postcode, country) 
VALUES (NULL, '".$_SESSION['adults']."' , '".$_SESSION['childrens']."', '".$_SESSION['checkin_db']."', '".$_SESSION['checkout_db']."', '".$_SESSION['special_requirement']."', 'pending', '".$_SESSION['total_amount']."', '".$_SESSION['offer']."', '".$_SESSION['firstname']."', '".$_SESSION['lastname']."', '".$_SESSION['email']."', '".$_SESSION['phone']."', '".$_SESSION['addressline1']."', '".$_SESSION['addressline2']."', '".$_SESSION['city']."', '".$_SESSION['state']."', '".$_SESSION['postcode']."', '".$_SESSION['country']."')");
echo mysql_error();
...
$message .="														</tr>\n";
$message .="														<tr>\n";
$message .="															<td style=\"width:200px;\">15% Offer Due</td>\n";
$message .="															<td  style=\"width:200px;\"><b>RM".$_SESSION['offer']."</b></td>\n";
$message .="														</tr>\n";;
$message .="														\n";
$message .="													</table>\n";
...
$message .="					<input type=\"hidden\" name=\"item_name\" value=\"15% Hotel Offer for Booking ID #".$_SESSION['booking_id']."; \">\n";
$message .="					<input type=\"hidden\" name=\"amount\" value=\"".$_SESSION['offer']."\">\n";
$message .="					<input type=\"hidden\" name=\"currency_code\" value=\"$\">\n";
...
$message .="															<br>\n";
$message .="															<b>1. Please pay 15% offer to confirmed your booking.</b><br>\n";
